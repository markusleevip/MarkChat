...
import com.mark.chat.gateway.ExternalHelper;
...
public class ExternalKit {
    ...
    public ExternalMessage convertExternalMessage(ResponseMessage responseMessage) {
        ...
        // 将routeId传到扩展消息
        externalMessage.setRouteId(responseMessage.getRouteId());
     ...
     * @return
     */
    public ExternalMessage createExternalMessage(RouteEnum routeEnum) {
        ExternalMessage externalMessage = ExternalKit.createExternalMessage();
        externalMessage.setCmdCode(routeEnum.getCmd());
        externalMessage.setCmdMerge(routeEnum.getCmd(), routeEnum.getSubCmd());
        return externalMessage;
