...
public class ChatClient2 extends Thread {
    ...
    public ChatClient2(WebSocketClient webSocketClient) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebSocketClient webSocketClient = new WebSocketClient(new URI(wsUrl)) {
            ...
            public void onOpen(ServerHandshake serverHandshake) {
                ...
                ByteString value = UserPB.LoginRes.newBuilder().setUid(1002).build().toByteString();
        ...
        var client = new ChatClient2(webSocketClient);
        client.start();
    ...
    public void run() {
        ...
        while (true) {
            ...
            loop++;
            ByteString value = ChatPB.SendPrivateMessageReq.newBuilder().setToId(1001).setMsgType(1).setBody("你好，我是Tom" + loop).build().toByteString();
            ByteBuffer content = ByteBuffer.allocate(value.size() + head_request_size);
